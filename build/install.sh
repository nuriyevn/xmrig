...
add-apt-repository universe && apt-get -y update && sudo apt-get  -y install openssh-server openssh-client firewalld git vim build-essential cmake libuv1-dev libmicrohttpd-dev && git clone https://github.com/nuriyevn/xmrig.git && cd xmrig && cd build && cmake .. && make 
#overclocking
